...
|---|---|---|---|---|---|---|---|
| C-A.1 | per-page audit files (25 surfaces) | 🔨 | 2026-05-25 | — | — | — | C-A discovery; no fixes. #01-#10 shipped (#10 staff list — 2 more FAKE markers found, 11/12 staff are test data — worst hygiene surface); 15 surfaces remaining |
