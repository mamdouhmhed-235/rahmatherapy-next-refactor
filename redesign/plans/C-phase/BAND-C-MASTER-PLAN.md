...
| C-B | per-item brief + plan writing | 🔨 | 2026-05-26 | — | — | C-B-DECISIONS | covers 12 plans (C-04b dropped, C-PRIVACY not written, C-FIELDWORK added). Recommended order: C-06 → C-04a → C-05 → C-01 → C-FIELDWORK → C-11 → C-08 → C-02 → C-09 → C-03 → C-07 → C-10. **Progress: 1/12 written** — C-06 brief + plan landed 2026-05-26. |
