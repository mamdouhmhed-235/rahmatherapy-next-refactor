...
| C-04a | Cancellation restore | ⏳ (brief + plan ✅) | — | — | — | C-B | item 4 — **must ship before/with C-05** (load-bearing). Plus hygiene tail (remove dead refunded/waived filters + 1-char reports fix). **Brief + plan written 2026-05-26** — `redesign/briefs/C-04a-cancellation-restore-brief.md` + `redesign/plans/C-phase/C-04a-cancellation-restore-plan.md`. Implementation ⏳ pending. |
| ~~C-04b~~ | ~~Refund modal~~ | **DROPPED** | — | — | — | — | Payment is in-person, no in-app refund tracking. See C-B-DECISIONS §2 Q8. |
| C-05 | Bug: cancelled bookings claim/assign | ⏳ (brief + plan ✅) | — | — | — | C-B, C-04a | item 5 — lock down via `ensureBookingActive` helper at 7 edit points. **Brief + plan written 2026-05-26** — `redesign/briefs/C-05-cancelled-bookings-inert-brief.md` + `redesign/plans/C-phase/C-05-cancelled-bookings-inert-plan.md`. Implementation ⏳ pending C-04a. |
