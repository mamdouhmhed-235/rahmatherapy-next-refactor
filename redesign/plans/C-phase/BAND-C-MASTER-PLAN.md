...
| C-B | per-item brief + plan writing | ✅ | 2026-05-26 | 2026-05-26 | (this commit) | C-B-DECISIONS | covers **22 plans** (C-04b dropped, C-PRIVACY not written, C-FIELDWORK added, C-13 + C-14 added post-handoff via user direction, **C-15 + C-16 + C-17 + C-18 + C-19 + C-20 + C-21 + C-22 added 2026-07-16 via user direction — plan-refinement phase**). Recommended order: C-06 → C-04a → C-05 → C-01 → C-FIELDWORK → C-11 → C-08 → **C-15** → C-13 → C-02 → C-09 → C-03 → C-07 → **C-16** → C-10, with **C-14 + C-17/C-18 + C-19 + C-20 + C-21 + C-22** independent (C-14 Phase D customer-picker, the C-17+C-18 GA/consent pair, C-19's privacy page, C-20's address autocomplete, C-21's canonical-domain fix, and C-22's booking-form abuse protection can each ship first; break phases anytime; **C-18 co-ships with C-17**; **C-21 + C-22 are small and worth shipping early**). **Progress: 22/22 ✅ COMPLETE** — original 12 landed 2026-05-26; C-13 + C-14 added same day; C-15 + C-16 + C-17 + C-18 + C-19 added 2026-07-16 (alongside the C-08 business-notifications + C-04a S7 amendments). C-C implementation is now unblocked. |
