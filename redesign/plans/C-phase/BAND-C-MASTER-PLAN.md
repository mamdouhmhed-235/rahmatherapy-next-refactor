...
|---|---|---|---|---|---|---|---|
| C-A.1 | per-page audit files (25 surfaces) | 🔨 | 2026-05-25 | — | — | — | C-A discovery; no fixes. #01 dashboard + #02 bookings list shipped (#02 located C-05 root cause at `actions.ts:269-275`); 23 surfaces remaining |
