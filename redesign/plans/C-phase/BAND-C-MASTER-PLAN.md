...
| C-06 | Delete + bulk delete + client CRUD hardening | ⏳ (brief + plan ✅) | — | — | — | C-B | item 6 — **EXPANDED to 11 steps.** Absorbs B-110/B-131 destructive-overwrite fix + B-34 client edit (Q6) + privacy GDPR honesty fix (Q2). Largest plan alongside C-02. **Brief + plan written 2026-05-26** — `redesign/briefs/C-06-client-crud-hardening-brief.md` + `redesign/plans/C-phase/C-06-client-crud-hardening-plan.md`. Implementation ⏳ pending. |
