...
|---|---|---|---|---|---|---|---|
| C-A.1 | per-page audit files (25 surfaces) | 🔨 | 2026-05-25 | — | — | — | C-A discovery; no fixes. #01-#06 shipped (#06 surfaced DuplicateWarningBanner pattern exists at ClientCreateForm.tsx:461-489 — should be lifted to ManualBookingForm per #03 B-09); 19 surfaces remaining |
