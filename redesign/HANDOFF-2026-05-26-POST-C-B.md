...
- **Second defect, same sweep:** the site publishes **`hello@rahmatherapy.co.uk`, which the user confirmed does not exist** (2026-07-16) — customers emailing the contact address reach nobody. Real address: **`rahmatherapy@outlook.com`**. Arguably more urgent than the SEO issue; ships in the same commit.
