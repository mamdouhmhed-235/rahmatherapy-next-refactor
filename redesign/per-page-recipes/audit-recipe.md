...
8. `DEV_SERVER_READY at http://localhost:3003`
...
14. `AUDIT_WRITES_ON_LOAD: 0` and `REDACTION_REGEX_VERBATIM: yes`
15. `## audit — audit` and `## audit — critique` headings appended (printed to chat from the file)
