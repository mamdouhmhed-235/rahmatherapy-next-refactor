...
Absolutes captured above so a future comparison has a real anchor. **Corrected by drift checkpoint #3 (2026-08-03): this is the NINTH plan hit by the same gap, not the fourth.** The full list is C-04a, C-05, C-FIELDWORK, C-08, C-15, C-13, C-02, C-03, C-07 — the programme's running "third"/"fourth" tallies disagreed with each other and substantially undercounted. Every instance was honestly recorded as NOT RUN rather than falsely passed; the reporting was sound, the arithmetic was not. C-03's precedent (ship ✅ with the gate recorded NOT RUN) is the one followed here. Raised in chat at closeout and logged to `OWNER-ACTION-BACKLOG.md` as a recurring measurement blind spot rather than treated as a C-07 defect. Evidence: `redesign/evidence/C-07/closeout-static-gates.md`.
