...
| `/reviews` | Strong concept, but trust proof is weakened by placeholder hero media and plain inline proof text. | Consistent rounded review cards. | Review wall is controlled and scannable. | Strong hero scale. | Review cards over placeholder remain readable. | Clear booking and review exploration CTAs. | Leave-review CTA is coherent. | Strong but placeholder-backed. | Placeholder hero plus rewritten/excerpted proof area reduces polish. | VISUAL-001, VISUAL-002, UX-001 |
