  ...
  return (
    <div className="grid gap-5 pb-20 lg:pb-0">
      <div className="grid gap-2">
        <div className="h-9 w-32 animate-pulse rounded-[var(--admin-radius-control)] bg-[var(--admin-panel-muted)]" />
        ...
        {Array.from({ length: 8 }).map((_, index) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1 grid gap-1.5">
              <span className="h-3.5 w-40 animate-pulse rounded bg-[var(--admin-panel-muted)]" />
              <span className="h-3 w-28 animate-pulse rounded bg-[var(--admin-panel-muted)]" />
            </div>
