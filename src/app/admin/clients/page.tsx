        ...
        <div className="grid grid-cols-2 gap-2">
          <label
            className={`inline-flex h-10 items-center justify-center rounded-[var(--admin-radius-control)] border px-3 text-sm font-medium ${
              sort === "name"
                ? "border-[var(--admin-primary)] bg-[oklch(92%_0.022_155)] text-[var(--admin-heading)]"
...
function ClientRow({
  ...
  return (
    <li
      className={`group relative flex min-h-[56px] items-center gap-3 rounded-[var(--admin-radius-control)] border-b border-b-transparent px-3 py-2 transition-colors duration-150 ease-out hover:bg-[oklch(95.5%_0.012_155)] hover:border-b-[oklch(60%_0.08_155)] focus-within:bg-[oklch(95.5%_0.012_155)] md:gap-4 md:px-4 ${rowOpacity}`}
    >
      <span
        aria-hidden="true"
      ...
      <Link
        ...
        className="relative z-10 hidden h-9 items-center gap-1.5 rounded-[var(--admin-radius-control)] px-2.5 text-xs font-semibold text-[var(--admin-body)] outline-none transition-colors hover:bg-[oklch(92%_0.022_155)] focus-visible:ring-2 focus-visible:ring-[var(--admin-focus)]/55 md:inline-flex"
      >
        <Plus className="size-4" aria-hidden="true" />
        New booking
      </Link>
      ...
      {alphabet.map((letter) => {
        ...
        return enabled ? (
          <a
            ...
            className="flex size-5 items-center justify-center rounded-full text-[0.6875rem] font-semibold text-[var(--admin-text-muted)] outline-none transition-colors hover:bg-[oklch(92%_0.022_155)] hover:text-[var(--admin-heading)] focus-visible:ring-2 focus-visible:ring-[var(--admin-focus)]/55"
          >
            {letter}
          </a>
        ) : (
