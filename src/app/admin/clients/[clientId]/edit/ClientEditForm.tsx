...
function StickySaveBar({
  ...
  return (
    <div className="sticky bottom-0 z-30 -mx-4 mt-2 border-t border-[var(--admin-border)] bg-[var(--admin-panel)] px-4 pb-[max(env(safe-area-inset-bottom),0.75rem)] pt-3 md:static md:bottom-auto md:mx-0 md:border-0 md:bg-transparent md:px-0 md:pb-0">
