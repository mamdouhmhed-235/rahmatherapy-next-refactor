          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isToday
                  ? "border-[var(--admin-primary)] bg-[oklch(95.5%_0.012_155)]"
                  : inMonth
            ...
            <li key={date}>
              <Link
                ...
                className={cn(
                  ...
                  isToday
                    ? "border-[var(--admin-primary)] bg-[oklch(95.5%_0.012_155)] text-[var(--admin-heading)]"
    ...
    <span className="inline-flex -space-x-1.5" aria-hidden="true">
      {visible.map((name) => (
        <span
          key={name}
          title={name}
          className="inline-flex size-7 items-center justify-center rounded-full border-2 border-[var(--admin-panel)] bg-[oklch(95.5%_0.012_155)] text-[0.625rem] font-semibold text-[var(--admin-heading)]"
        >
          {initials(name)}
        </span>
      ))}
    ...
    >
      <div className="flex items-center gap-2">
        <span
          aria-hidden="true"
          title={clientName}
          className="inline-flex size-8 shrink-0 items-center justify-center rounded-full bg-[oklch(95.5%_0.012_155)] text-xs font-semibold text-[var(--admin-heading)]"
        >
          {initials(clientName)}
        </span>
