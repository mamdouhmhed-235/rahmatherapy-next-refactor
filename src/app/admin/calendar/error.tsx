...
export default function CalendarError({ error, reset }: CalendarErrorProps) {
  useEffect(() => {
    if (typeof console !== "undefined") {
      console.error("/admin/calendar load failure:", error);
    }
  }, [error]);
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm leading-6 text-[var(--admin-text-muted)]">
              The day or week view didn&apos;t come back. This is usually temporary. If it keeps happening, contact the owner.
            </p>
            <div className="mt-4">
              <button
                type="button"
