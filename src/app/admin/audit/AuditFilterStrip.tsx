      ...
      {DATE_RANGE_PRESETS.map((preset) => {
        ...
        return (
          <button
            ...
            className={
              active
                ? "inline-flex h-9 shrink-0 items-center gap-1.5 rounded-full bg-[var(--admin-primary)] px-3.5 text-sm font-medium text-[var(--admin-on-primary)] shadow-[0_0_0_2px_var(--admin-ring-gap),0_0_0_3px_var(--admin-primary)] outline-none focus-visible:ring-2 focus-visible:ring-[var(--admin-focus)]/55"
