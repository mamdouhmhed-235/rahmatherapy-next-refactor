...
interface EnquiriesErrorProps {
  error: Error & { digest?: string };
  reset: () => void;
}

export default function EnquiriesError({ error, reset }: EnquiriesErrorProps) {
  useEffect(() => {
    if (typeof console !== "undefined") {
      console.error("/admin/enquiries load failure:", error);
    }
  }, [error]);
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm leading-6 text-[var(--admin-text-muted)]">
              The enquiry pipeline didn&apos;t come back. This is usually temporary. If it keeps happening, contact the owner.
            </p>
            <div className="mt-4">
              <button
                type="button"
