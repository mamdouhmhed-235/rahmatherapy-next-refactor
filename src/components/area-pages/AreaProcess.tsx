        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
          {homeProcessSteps.map((step) => (
            <div key={step.number} className="relative flex flex-col items-center text-center">
              <div className="relative z-10 flex size-14 items-center justify-center rounded-full bg-rahma-green font-display text-base font-semibold text-white ring-8 ring-rahma-sand">
                {step.number}
              </div>
