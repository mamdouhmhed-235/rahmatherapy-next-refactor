          ...
          >
            ...
            <div className="absolute inset-x-0 bottom-0 z-10 p-6 text-white sm:p-7">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <strong className="rounded-full bg-white px-4 py-2 text-lg font-semibold text-rahma-green shadow-sm">
                  {service.price}
                </strong>
              </div>
              ...
              <div className="mt-4 rounded-3xl border border-white/15 bg-white/10 p-4 backdrop-blur-sm">
                ...
                <p className="mt-2 text-sm leading-6 text-white/78">{service.bestFor}</p>
              </div>
