...
export const teamMembers = [
  {
    ...
    bullets: [
      ...
      "Massage therapy",
      "Clear consultation before treatment",
...
export const comfortCards = [
  {
    title: "Private home appointments",
    body: "Treatment in your own space.",
  },
  {
    title: "Everything explained first",
    body: "Know what to expect before treatment begins.",
  },
  {
    title: "Female clients treated by female therapist",
    body: "Same-gender care for comfort and modesty.",
  },
  {
    title: "Aftercare guidance included",
    body: "Simple advice after your session.",
  },
] as const;
