-- Migration: update create_booking_request to support per-participant services
-- Date: 2026-05-13
-- Purpose: allow each participant to have different services in admin manual bookings
